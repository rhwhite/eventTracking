...
FileO = 'Monthly_Precip_Sizes_' + str(startyr) + '-' + str(endyr) + '_3.nc'
...
Msspan = ncfile.createVariable('gridboxspan','f4',('months','events'),fill_value=-9999)
