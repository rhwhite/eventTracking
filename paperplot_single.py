...
print nyears
mapping = "center"
FigDir = '/home/disk/eos4/rachel/Figures/PrecipEvents/1998mov/'
...
if Data == "TRMM":
	...
	if Version == "ERAIgd":
		Filename = "Regrid_" + str(sumlats) + "_" + str(sumlons) + "_regrid2ERAI_TRMM_3B42_1998-2014_annclim.nc" 
	        ...
	        Filename = "TRMM_1998_3B42_3hrly_nonan.nc" 
...
for iday in range(0,ndays):
	...
	title = ('Precip, mm/hr, 1998 day ' + str(day))
	figtitlein = FigDir + Data + '_1998_' + '{:04.4g}'.format(iday) 
