...
teststring = '{0: ^60}'.format("something")
print teststring
...
tspanbinedges = [0,8.1,16.1,40.1,500]#6.5,7.5,8.5]
...
sspan = datain['gridboxspanSA']
totalprecip = datain['totalprecipSA']
xmin1 = datain['xmin']
...
if plotdensity:
        figtitle = "Paper_" + Data + "_" + Version + '_' + vartitle + '_dens'
else:
        figtitle = "Paper_" + Data + "_" + Version + '_' + vartitle + '_numb'
