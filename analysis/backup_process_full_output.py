...
#DirP = '/home/disk/eos4/rachel/Obs/TRMM/' + timespan + '/'
...
xcentstart = ncfile.createVariable('ycenstart','f4',('events'),fill_value=-9999)
ycentstart = ncfile.createVariable('xcenstart','f4',('events'),fill_value=-9999)
