...
def ploteachpanel(precipclimin,origlonsin,titlein):
...
def precipplot(precipannin, origlonsin, titlein,nplots,nrows):
    ...
    if nplots > 1:
        for iplot in range(0,nplots):
            ...
            ploteachpanel(precipannin[iplot],origlonsin,titlein[iplot])

    else:
        ploteachpanel(precipannin,origlonsin,titlein)
...
## Now plot regression.
precipplot([filePrecipReg['pcp'],filePrecipReg2['pcp']],filePrecipReg['pcp'].coords['longitude'], ['Regression of annual mean rainfall from TRMM 1998-2014','Regression of annual mean rainfall from TRMM 1999-2014'],2,2)
