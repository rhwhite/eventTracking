...
gridboxspan = ncfile.createVariable('gridboxspan','f4',('events'),fill_value=-9999)
totalprecip = ncfile.createVariable('totalprecip','f4',('events'),fill_value=-9999)
ungridboxspan = ncfile.createVariable('uniquegridboxspan','f4',('events'),fill_value=-9999)
gridboxspanSA = ncfile.createVariable('gridboxspanSA','f4',('events'),fill_value=-9999)
totalprecipSA = ncfile.createVariable('totalprecipSA','f4',('events'),fill_value=-9999)
ungridboxspanSA = ncfile.createVariable('uniquegridboxspanSA','f4',('events'),fill_value=-9999)
