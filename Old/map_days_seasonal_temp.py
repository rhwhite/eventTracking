...
speedtspan = 4
# In m/s
tbound = np.array([-3,])# [0,1,2,5])
tbound2 = np.array([3])# [1,2,5,100]
nbounds = len(tbound)
unit = "ms"
...
for ibound in range(0,nbounds):
	...
	initvars = ['ExmaxSpeed','WxmaxSpeed','ETotalPrecip', 'WTotalPrecip', 'STotalPrecip','TPrecip', 'EPrecip', 'WPrecip', 'SPrecip', 'EDensity', 'WDensity','SDensity', 'TDensity', 'EZSpeed', 'WZSpeed', 'SZSpeed', 'EDistance', 'WDistance', 'SDistance', 'ESize', 'WSize', 'SSize', 'EUSize', 'WUSize', 'SUSize', 'ESizeSA', 'WSizeSA', 'SSizeSA', 'EUSizeSA', 'WUSizeSA', 'SUSizeSA', 'ETSpan', 'WTSpan', 'STSpan']
