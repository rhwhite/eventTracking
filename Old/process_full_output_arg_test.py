...
resource.setrlimit(rsrcV, (100000000000, hard)) #limit memory usage
#                          137438953472
soft, hard = resource.getrlimit(rsrcV)
...
if args.Data[0] not in ['TRMM','ERAI','CESM','TRMM_ERAIgd']:
...
if Data == "TRMM":
	...
	if Version == "Standard":
		...
		FileO = 'TestPrecip_Sizes_' + str(startyr) + '-' + str(endyr) + '_Standard.nc'
		...
		FileO = 'TestPrecip_Sizes_' + str(startyr) + '-' + str(endyr) + '_7thresh.nc'
		...
		FileO = 'TestPrecip_Sizes_' + str(startyr) + '-' + str(endyr) + '_5th_n2zero.nc'
	...
	Filegrid = Data + "_SurfaceArea.nc"
        ...
        TxtFileIn = 'TRMM_ERAIgd_' + str(startyr) + '-' + str(endyr) + '_4Dobject_tree.txt'
        FileO = 'Precip_Sizes_TRMM_' + str(startyr) + '-' + str(endyr) + '_ERAIgd.nc'
elif Data == "ERAI":
	startyr = 1980
	endyr = 2015
	Pfilestartyr = 1980
	...
	FileO = 'TestPrecip_Sizes_ERAI' + str(startyr) + '-' + str(endyr) + '_' + Version + '.nc'
elif Data == "CESM":
	Pfilestartyr = 1979
	Pfileendyr = 2012
	...
	Filegrid = "SurfaceArea.nc"
        ...
        FileO = 'TestPrecip_Sizes_CESM' + str(startyr) + '-' + str(endyr) + '_' + Version + '.nc'
